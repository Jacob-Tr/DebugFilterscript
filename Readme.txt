Generally useful SA-MP Gamemode setup and debug in-game utilities.
 ...
 - Vehicle Command          /v [Vehicle Model ID] [Color 1]* [Color 2]* ~ Spawns a vehicle of the specified Model ID with either random colors or those specified in the following paramterers.
